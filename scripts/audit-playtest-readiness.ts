...
const requiredLocalFiles: ReadinessFileRequirement[] = [
  ...
  { path: "docs/current_surface_contract.md" },
  { path: "docs/mobile_shell.md" },
  ...
  { path: "docs/mobile_device_evidence_manifest.md" },
  { path: "docs/mobile_device_validation_completed_template.md" },
  { path: "docs/mobile_device_observer_note_template.md" },
  { path: "docs/mobile_device_input_feel_summary_template.md" },
  { path: "docs/browser_qa_2026-06-06.md" },
  { path: "docs/browser_qa_2026-06-07.md" },
  { path: "scripts/evaluate-playtest-notes.ts" },
  { path: "scripts/evaluate-playtest-rollup.ts" },
  { path: "scripts/evaluate-mobile-cross-reference.ts" },
  { path: "scripts/evaluate-mobile-surface-evidence.ts" },
  { path: "scripts/evaluate-mobile-runtime-evidence.ts" },
  { path: "scripts/evaluate-mobile-evidence-freshness.ts" },
  { path: "scripts/evaluate-ios-simulator-evidence.ts" },
  { path: "scripts/evaluate-mobile-device-validation.ts" }
];
